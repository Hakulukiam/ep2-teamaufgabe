...
public class Aufgabe1 {
    static Umkreissuche u;

    public static void main(String[] args){
        u = new Umkreissuche("/data/junctions.csv", 0);
    ...
    private static void control(){
        ...
        while(true) {
            ...
            if(!validCommand(command)){
                ...
                switch (params[0]){
                    case "Junctions":
                        int[] inRange = u.inRange(new double[]{Double.valueOf(params[6].split("=")[1]),Double.valueOf(params[7].split("=")[1])},Double.valueOf(params[3]));
                        System.out.println("Airports: "+inRange[0]+" Trainstations: "+inRange[1]);
                        break;
                    case "Airports":
                        System.out.println(u.AirportsWithTrainstations(15.0,20));
                        break;
                }
            }
        }
